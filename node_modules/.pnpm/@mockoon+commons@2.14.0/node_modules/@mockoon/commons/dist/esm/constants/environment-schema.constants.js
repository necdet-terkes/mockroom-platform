...
import { BodyTypes, Methods, ResponseMode, RouteType } from '../models/route.model';
...
export const DataBucketDefault = {
    get uuid() {
        return uuid();
    },
    get id() {
...
export const FolderChildSchema = Joi.object({
    type: Joi.string()
        .valid('route', 'folder')
        .required()
        .options({ stripUnknown: true }),
...
export const RouteSchema = Joi.object({
    ...
    method: Joi.string()
        .allow('')
        .valid(Methods.get, Methods.post, Methods.put, Methods.patch, Methods.delete, Methods.head, Methods.options, Methods.propfind, Methods.proppatch, Methods.move, Methods.copy, Methods.mkcol, Methods.lock, Methods.unlock)
    ...
    responseMode: Joi.string()
        .allow(null)
        .valid(ResponseMode.RANDOM, ResponseMode.SEQUENTIAL, ResponseMode.DISABLE_RULES)
