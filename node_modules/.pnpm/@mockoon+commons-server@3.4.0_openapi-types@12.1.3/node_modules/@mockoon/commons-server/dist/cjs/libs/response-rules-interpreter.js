...
class ResponseRulesInterpreter {
    constructor(routeResponses, request, responseMode) {
        ...
        this.isValidRule = (rule, requestNumber) => {
            ...
            if (rule.target === 'cookie') {
                ...
                if (rule.modifier) {
                    let path = rule.modifier;
                    if (typeof path === 'string') {
                        path = (0, utils_1.convertPathToArray)(path);
                    }
                    value = (0, object_path_1.get)(this.targets[rule.target], path);
                }
            ...
            if (rule.operator.includes('regex')) {
                regex = new RegExp(rule.value, rule.operator === 'regex_i' ? 'i' : undefined);
    ...
    extractTargets() {
        ...
        if (requestContentType) {
            if ((0, utils_1.stringIncludesArrayItems)(common_constants_1.ParsedBodyMimeTypes, requestContentType)) {
