...
import { BuildEnvironment, BuildHeader, BuildRoute, BuildRouteResponse, GetRouteResponseContentType, INDENT_SIZE, Methods, RemoveLeadingSlash, RouteType } from '@mockoon/commons';
...
export class OpenAPIConverter {
    ...
    async convertToOpenAPIV3(environment) {
        const routes = routesFromFolder(environment.rootChildren, environment.folders, environment.routes);
        ...
        Object.keys(parsedAPI.paths).forEach((routePath) => {
            Object.keys(parsedAPI.paths[routePath]).forEach((routeMethod) => {
                ...
                if (routeMethod in Methods) {
                    ...
                    const newRoute = Object.assign(Object.assign({}, BuildRoute(RouteType.HTTP, false)), { documentation: parsedRoute.summary || parsedRoute.description || '', method: routeMethod, endpoint: RemoveLeadingSlash(this.v2ParametersReplace(routePath)), responses: routeResponses });
    ...
    buildResponse(body, label, statusCode, headers) {
        return Object.assign(Object.assign({}, BuildRouteResponse()), { body: body !== undefined
                ? this.convertJSONSchemaPrimitives(JSON.stringify(body, null, INDENT_SIZE))
                : '', label,
            statusCode,
            headers });
    }
