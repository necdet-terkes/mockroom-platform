 ...
 * @returns
 */
const findItemIndex = (databucketValue, request) => databucketValue.findIndex((value, index) => {
    if (typeof value === 'object' && value !== null) {
        if (value[crudRouteParamName] == null) {
            return false;
        }
        return (value[crudRouteParamName].toString() ===
 ...
 * @returns
 */
export const crudRoutesBuilder = (routePath) => {
    const routes = [
 ...
 */
export const databucketActions = (crudId, databucket, request, response) => {
    if (databucket.parsed) {
        response.set('Content-Type', 'application/json');
    }
    let requestBody = request.body !== undefined ? request.body : request.stringBody || {};
    let responseBody = {};
    switch (crudId) {
        case 'get': {
            ...
            const page = typeof request.query.page === 'string'
                ...
                : 1;
            const sort = typeof request.query.sort === 'string' ? request.query.sort : null;
            const order = typeof request.query.order === 'string'
        ...
        case 'create': {
            if (Array.isArray(databucket.value)) {
                if (typeof requestBody === 'object' && requestBody != null) {
                    requestBody = Object.assign({ [crudRouteParamName]: uuid() }, requestBody);
                }
        ...
        case 'updateById': {
            if (Array.isArray(databucket.value)) {
                ...
                if (indexToModify !== -1) {
                    if (typeof databucket.value[indexToModify] === 'object' &&
                        databucket.value[indexToModify] != null) {
                        databucket.value[indexToModify] = Object.assign({ id: databucket.value[indexToModify].id }, (typeof requestBody === 'object' && requestBody != null
                            ? requestBody
                            : {}));
            ...
            if (Array.isArray(databucket.value) && Array.isArray(requestBody)) {
                ...
                databucket.value =
                    typeof databucket.value === 'object' && databucket.value != null
                        ? Object.assign(Object.assign({}, databucket.value), (typeof requestBody === 'object' && requestBody != null
                            ? requestBody
                            : {})) : requestBody;
                responseBody = databucket.value;
                response.status(200);
                ...
                if (indexToModify !== -1) {
                    databucket.value[indexToModify] =
                        typeof databucket.value[indexToModify] === 'object' &&
                            databucket.value[indexToModify] != null
                            ? Object.assign(Object.assign({}, databucket.value[indexToModify]), (typeof requestBody === 'object' && requestBody != null
                                ? requestBody
                                : {})) : requestBody;
                    responseBody = databucket.value[indexToModify];
                    response.status(200);
